...
//	LoadFrakcio();
	...
	//lsbank
	LsBankKapu=CreateDynamicObject(2634, 1931.56549229, -2435.53287467, 14.6419142578,  0.0000,  0.0000,  -20.0000, 1555);
...
//	UjPickup(1239, 23, -1942.973876, 556.252868, 35.171875); //SF Bank
	...
	Timerek[2] = SetTimer("RandomHirdetes", (hirdetesidokoz * 40 * 1000), 1);
	...
	Timerek[26] = SetTimer("ClientTimer", 3000, 1);
...
//	sonatimer = SetTimer("SonaFigyelo", 5000, 1);
	...
	DiscoZene = "http://yp.shoutcast.com/sbin/tunein-station.pls?id=1377360";
	RiporterZene = "";
