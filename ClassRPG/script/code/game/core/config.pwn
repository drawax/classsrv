...
//Beállítások
#define SERVER_PORT 7983 //alap 9999
...
#define JOGSI_MOTOR 70
#define JOGSI_AUTO 70
#define JOGSI_REPULO 90
#define JOGSI_HORGASZ 90
#define JOGSI_HAJO 90
#define JOGSI_KAMION 90
#define JOGSI_KRESZ 85
#define JOGSI_ADR 100
#define JOGSI_FEGYVER 190
#define AkkuMax 100
...
#define TERULET_FRAKCIO_LIMIT 12
...
// pénz
#define MUNKA_PENZ_SZORZO 2				// farmer / kukás / postás / úttisztító pénzszorzó
...
#define ADASVETELI_ADO 0.006 // Adásvételi biznisz
#define ARANY_KAMAT 0.07

#define MAX_HOUSE_PER_PLAYER	3
#define WEAPON_MIN_LEVEL		4 // minimum szint a fegyver használathoz
...
new IllegalisMunkak[6] = {
	8,//{MUNKA_FEGYVER, "Fegyverkereskedõ", 8}, //0
	3,//{MUNKA_PROSTI, "Prostituált", 3}, //1
	5,//{MUNKA_DROG, "Drogdíler", 5}, //2
