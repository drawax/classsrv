...
new KincsAktiv = NINCS, Text3D:KincsObject, KincsKod[12], bool:KincsMutat[MAX_PLAYERS], KincsIdo;
...
new Float:AlmossagRelog[MAX_PLAYERS];
new BoltRablasVW;
...
new LevelAKocsiban[MAX_VEHICLES];
...
new Mikrofon[MAX_PLAYERS];
new SzedKocsi[MAX_PLAYERS];
new SzedZseb[MAX_PLAYERS];
new Zeneenged[MAX_PLAYERS];
...
new Float:Almossag[MAX_PLAYERS], Bar:AlmossagBar[MAX_PLAYERS] = {INVALID_BAR_ID, ...};
#if defined Megbizas
...
new FeketeRadar;
new DiscoZene[256], DiscobanVan[MAX_PLAYERS char];
