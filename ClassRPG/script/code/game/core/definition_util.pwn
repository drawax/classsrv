...
#define IsClint(%1) (PlayerInfo[%1][pClint])
...
#define PLAYER_MARKER_WEAPONS_WEAPONHOLD(%1)	(WEAPON_SHOTGUN <= WeaponArmed(%1) <= WEAPON_SHOTGSPA||WEAPON_AK47 <= WeaponArmed(%1) <= WEAPON_M4||WeaponArmed(%1) == WEAPON_SNIPER)
#define PLAYER_MARKER_WEAPONS_TARGET(%1)		(WEAPON_SHOTGUN<=WeaponArmed(%1)<=WEAPON_SHOTGSPA||WEAPON_AK47<=WeaponArmed(%1)<= WEAPON_M4||WEAPON_RIFLE<=WeaponArmed(%1)<=WEAPON_SNIPER)
...
#define IsACop(%1) (LMT(%1, FRAKCIO_SCPD) || LMT(%1, FRAKCIO_FBI) || LMT(%1, FRAKCIO_CIA) || LMT(%1, FRAKCIO_SFPD) || LMT(%1, FRAKCIO_NAV) || LMT(%1, FRAKCIO_KATONASAG) || PlayerInfo[%1][pSwattag] > 0)
...
// SQL
#define sql_get_str(%1,%2) cache_get_row(0,%1,%2)
#define sql_get_str_len(%1,%2,%3) cache_get_row(0,%1,%2,_,%3)
#define sql_get_int(%1) cache_get_row_int(0,%1)
#define sql_get_float(%1) cache_get_row_float(0,%1)
#define sql_get_row_str(%1,%2,%3) cache_get_row(%1,%2,%3)
#define sql_get_row_str_len(%1,%2,%3,%4) cache_get_row(%1,%2,%3,_,%4)
#define sql_get_row_int(%1,%2) cache_get_row_int(%1,%2)
#define sql_get_row_float(%1,%2) cache_get_row_float(%1,%2)
