...
<tr>
	...
	<?
		...
		{
			$sql = mysql_query("SELECT Szint, Member, Rank, Money, Bank FROM playerek WHERE id = '".$jatekos["Karakter"][0]["ID"]."'");
...
else
{
	...
	$tablak = Array(
		...
		"3" => Array(
			...
			Array("nev" => "Admin", "ertek" => ($k["Admin"] == "0" ? "Nem" : "<font color='yellow'><b>".$k["Admin"]."</b></font>")),
