...
stock Torlesek() { //orem
	...
	//Keny házánál a cuccok törlése - 2014.11.06.
	RemoveBuildingForPlayer(playerid, 3736, 301.3906, -1342.1094, 55.7891, 0.25);
	RemoveBuildingForPlayer(playerid, 669, 298.4219, -1355.3281, 52.0938, 0.25);
	RemoveBuildingForPlayer(playerid, 3606, 301.3906, -1342.1094, 55.7891, 0.25);
	RemoveBuildingForPlayer(playerid, 671, 294.6797, -1320.0078, 52.5156, 0.25);
	RemoveBuildingForPlayer(playerid, 620, 296.2266, -1321.1875, 52.2266, 0.25);
	RemoveBuildingForPlayer(playerid, 620, 309.4141, -1316.4453, 52.1250, 0.25);
	RemoveBuildingForPlayer(playerid, 691, 302.5859, -1311.1953, 51.8672, 0.25);

	//Marcell O Neill Birtok - Marci - 2014.11.04
	...
	//Creed Birtok - Damien Creed - 2014.11.04
	...
	//LCN HQ - Victor Gonzales - 2014.11.02
	...
	//Crasht okozó objectek törlése - Kiji - 2014.03.20
	RemoveBuildingForPlayer(playerid, 1374, 2266.8359, -2242.9219, 14.1016, 0.25);
	RemoveBuildingForPlayer(playerid, 1373, 2283.8125, -2243.4453, 15.3125, 0.25);
	RemoveBuildingForPlayer(playerid, 1374, 2284.4766, -2241.8516, 14.1016, 0.25);
	RemoveBuildingForPlayer(playerid, 1373, 2267.5000, -2241.3281, 15.3125, 0.25);
	...
	RemoveBuildingForPlayer(playerid, 1373, 2194.1016, -1899.5078, 15.3125, 0.25);
	RemoveBuildingForPlayer(playerid, 1373, 2207.1328, -1889.4688, 15.3125, 0.25);
	...
	//EP-7 - Pedro(Victor_Gates) - 2014.01.03
	...
	//ONKORMANYZAT JOHN_MONROE - 2013-10-22
	...
	//Brasco Étterem 1 (Santa Maria) - 2013.10.01 - Pedro Brasco
	...
	//Brasco Étterem 2 (Pizzahut) - 2013.10.01 - Pedro Brasco
	...
	//Katona Interior - John O Neill - 2013.08.11
	...
	RemoveBuildingForPlayer(playerid, 3758, 2299.1875, -2405.3984, 3.0391, 0.25);
	RemoveBuildingForPlayer(playerid, 3758, 2511.4766, -2256.0313, 3.0391, 0.25);
	...
	RemoveBuildingForPlayer(playerid, 3753, 2299.1875, -2405.3984, 3.0391, 0.25);
	...
	RemoveBuildingForPlayer(playerid, 3753, 2511.4766, -2256.0313, 3.0391, 0.25);
	...
	//LCN HQ - Kinzo Bratislav - 2013.12.24
	RemoveBuildingForPlayer(playerid, 729, -58.5313, -292.3281, 4.5859, 0.25);
	...
	//Dolph házának zavaró objectjei 2012.12.28
	...
	RemoveBuildingForPlayer(playerid, 1215, 1653.0000, -1362.9922, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1639.7578, -1361.9141, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1651.9531, -1361.7188, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1639.7344, -1349.7031, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1639.7344, -1354.8828, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1651.9531, -1350.9844, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1639.7344, -1337.3984, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1639.7344, -1342.3438, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1639.7656, -1330.2813, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1651.9531, -1335.5078, 16.9766, 0.25);
	...
	RemoveBuildingForPlayer(playerid, 1215, 1689.9375, -1362.9922, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1679.2188, -1362.9922, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1663.7109, -1362.9922, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1691.0938, -1361.8906, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 4602, 1671.5078, -1343.3359, 87.5391, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1691.1563, -1351.1016, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1663.6563, -1323.7109, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1679.1719, -1323.7656, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1691.1250, -1335.7344, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1691.1484, -1324.8906, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1215, 1689.9375, -1323.7656, 16.9766, 0.25);
	RemoveBuildingForPlayer(playerid, 1294, 1672.1094, -1307.6250, 17.6875, 0.25);
	...
	//Terno Régi oktató SF kapi - 2012-04-17
	...
	//Terno Tommy 2012.01.20 Oktató hq elõtt egy villanyoszlop
	RemoveBuildingForPlayer(playerid, 1297, 1052.8438, -1468.0859, 15.9375,0.25);

	//Északi benzinkút Épület és tábla Terno 2012.01.20
	...
	//San Fierro WangCars melletti Bonano étterem
	RemoveBuildingForPlayer(playerid, 672, -1989.5313, 317.3828, 34.0156, 0.25);
	
	//Yakuza HQ - Sweet Vincenzo - 2013.08.06.
	RemoveBuildingForPlayer(playerid, 1231, -2496.2891, 90.2969, 36.8984, 0.25);
	RemoveBuildingForPlayer(playerid, 1231, -2476.7266, 104.7344, 36.8984, 0.25);
	RemoveBuildingForPlayer(playerid, 1231, -2471.0156, 90.2969, 36.8984, 0.25);
	...
	//Lily Miles - Riporter - 2013-08-06 
	...
	//Új szerelõ HQ - Victor Gonzales (és Lily) - 2014.07.18.
	...
	//SF szerelõHQ - Victor Gonzales - 2014.07.22
